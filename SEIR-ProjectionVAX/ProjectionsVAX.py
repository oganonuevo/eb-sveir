...
def csvRequirements(path,dfOutput,colName,dfOdeResult,dfHospital,startCIndex,end_date,data_dfPsgcEconDetails,treatlevel,data_geo,fitness,dateAdjValue,ic,ip,title):
    ...
    parent_dir = 'C:/Users/ogano/Desktop/FASSSTER/backend-projections/SEIR-ProjectionVAX/Projections/'+ str(title) + '/' + str(data_geo) #+ '/' + str(dateAdjustment) + '/' 
...
interventionCompliance,interventionPercentage, interventionStartDate,interventionEndDate, dateAdjustment, start_date,end_date, dateAdjValue, allCompartments,csvOn,vax1,vax2,jvax):#,vaxDate
    
    TIMESERIES_URL = "http://localhost:7177"
    ...
    parent_dir = "C:/Users/ogano/Desktop/FASSSTER/backend-projections/SEIR-ProjectionVAX/Projections/"
    ...
    for location in locations:
                ...
                for ic in interventionCompliance:
                    for ip in interventionPercentage:
                        ...
                        params = {
                            ...
                            "v1Value": vax1,"v2Value": vax2, "jValue": jvax #"vaxDate": vaxDate,
                        }
        ...
        parent_dir = 'C:/Users/ogano/Desktop/FASSSTER/backend-projections/SEIR-ProjectionVAX/Projections/'+ str(dirtitle) #+ '/' + str(dirtitle+fitTo)#+ '/' + str(data[0]['Geographical.Place']) #+ '/' + str(dateAdjustment) + '/' 
        path = os.path.join(parent_dir) 
...
def logParameters(param, filename):
    path = "C:/Users/ogano/Desktop/FASSSTER/backend-projections/SEIR-ProjectionVAX/Projections/"+filename
    f = open(path, "a")
